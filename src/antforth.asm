...
.tfind5_end:
        ...
        ; --- Story 2.2: Outer interpreter primitive tests ---
...
.tbl_end:
        ...
        ; Store ' ' at tib_buffer+0, 'H' at +1, 'I' at +2, ' ' at +3
        DW      w_LIT_cf, ' '
        DW      w_LIT_cf, tib_buffer
...
.tnum_end:
        ...
        ; --- Story 2.3: Number formatting and stack inspection tests ---
        ...
        ; Current stack should be empty (last test consumed all).
        ; But TOS is whatever was last. Let me set up cleanly.
        ; After the above tests, TOS has been popped for each.
        ; Actually after U.DOT, new TOS is popped from SP.
        ; The stack state depends on what was left from prior tests.
        ; Let's use a fresh setup: push exactly 1, 2, 3
        DW      w_LIT_cf, 1
        DW      w_LIT_cf, 2
        DW      w_LIT_cf, 3
        DW      w_DOT_S_cf
        ; Clean up: drop 3, 2, 1 (and whatever was under them)
        DW      w_DROP_cf
        DW      w_DROP_cf
        DW      w_DROP_cf
        ...
        ; Write "65 EMIT" to tib_buffer (7 chars)
        DW      w_LIT_cf, '6'
        DW      w_LIT_cf, tib_buffer
        DW      w_C_STORE_cf
        DW      w_LIT_cf, '5'
