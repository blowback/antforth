...
| **NFR6** | REPL survives any THROW (5 of 6 error categories; 6th — stack overflow — has no Epic-11 guard, documented gap) | Task 4 (AC #3 stress tests 766-770 — 5/5 PASS) | **PASS (Story 11.5.2 closed the stack-overflow gap; test 779 corollary added 2026-04-27)** |
