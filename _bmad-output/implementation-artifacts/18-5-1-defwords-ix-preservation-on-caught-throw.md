...
- `tests/banking_tests.fth` — modified: Probe-18.5.1-A and Probe-18.5.1-B added after the existing 18.5-e block (lines 1528+).
- `Makefile` — modified: probe assertions for 18.5.1-A and 18.5.1-B added to `test-repl-banking` target.
- `_bmad-output/implementation-artifacts/sprint-status.yaml` — modified: `18-5-1-defwords-ix-preservation-on-caught-throw` status transitioned ready-for-dev → in-progress → review.
- `_bmad-output/implementation-artifacts/18-5-1-defwords-ix-preservation-on-caught-throw.md` — modified: Dev Notes, baseline + post-edit measurements, Q1 disposition, audit table, agent record, debug log, completion notes, file list, change log.
